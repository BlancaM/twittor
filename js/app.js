...
postBtn.on('click', function() {
    ...
    fetch('https://twittorserver.herokuapp.com/api/saveMessage', {
        method: 'POST',
        headers: {
...
function getMensajes() {
    ...
    fetch('https://twittorserver.herokuapp.com/api/messages')
        .then( res => res.json() )
        .then( posts => {
...
function getPublicKey() {
    ...
    return fetch('https://twittorserver.herokuapp.com/api/key')
...
btnDesactivadas.on( 'click', function() {
    ...
    getPublicKey().then( function( key ) {
        ...
        .then( suscripcion => {
            ...
            fetch('https://twittorserver.herokuapp.com/api/subscribe', {
                method: 'POST',
